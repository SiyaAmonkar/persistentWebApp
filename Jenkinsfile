pipeline {
    ...
    stages {
        ...
        stage('Deploy')
        {   steps{
             deploy adapters: [tomcat8(credentialsId: '70028b46-d724-4557-b00e-111dd5eac392', path: '', url: 'http://localhost:9090/Persistent')], contextPath: 'Persistent', war: 'target/PersistentWebApp.war'
        }
        }
